...
export interface TimelockController$Type {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  export function deployContract(
    contractName: "TimelockController",
    constructorArgs: [minDelay: AbiParameterToPrimitiveType<{"name":"minDelay","type":"uint256"}>, proposers: AbiParameterToPrimitiveType<{"name":"proposers","type":"address[]"}>, executors: AbiParameterToPrimitiveType<{"name":"executors","type":"address[]"}>, admin: AbiParameterToPrimitiveType<{"name":"admin","type":"address"}>],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<TimelockController$Type["abi"]>>;
  export function deployContract(
    contractName: "@openzeppelin/contracts/governance/TimelockController.sol:TimelockController",
    constructorArgs: [minDelay: AbiParameterToPrimitiveType<{"name":"minDelay","type":"uint256"}>, proposers: AbiParameterToPrimitiveType<{"name":"proposers","type":"address[]"}>, executors: AbiParameterToPrimitiveType<{"name":"executors","type":"address[]"}>, admin: AbiParameterToPrimitiveType<{"name":"admin","type":"address"}>],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<TimelockController$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<TimelockController$Type["abi"]>;
